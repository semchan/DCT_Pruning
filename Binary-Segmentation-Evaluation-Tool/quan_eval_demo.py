...
data_dir = './data/DUTS/' # set the data directory,
...
gt_dir = 'DUTS-TE/DUTS-TE-Mask' # set the ground truth folder name
# rs_dirs = ['_DUTS-TE_results','u2net_results'] # set the folder names of different methods
rs_dirs = ['u2netp_DUTS-TE_results'] # set the folder names of different methods
